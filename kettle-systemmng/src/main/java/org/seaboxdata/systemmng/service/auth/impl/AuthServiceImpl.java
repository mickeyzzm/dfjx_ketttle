package org.seaboxdata.systemmng.service.auth.impl;
...
import org.seaboxdata.systemmng.utils.auth.RestTemplateUtils;
import org.seaboxdata.systemmng.utils.auth.UrlEnum;
...
public class AuthServiceImpl implements AuthService {
    ...
    private static String clientId = new PropertiesUtil("config/environment.properties").readProperty("client-id");
    private static String clientSecret = new PropertiesUtil("config/environment.properties").readProperty("client-secret");
    private static String authUrl = new PropertiesUtil("config/environment.properties").readProperty("auth-url");
    private static String authFrontierUrl = new PropertiesUtil("config/environment.properties").readProperty("auth-frontier-url");
