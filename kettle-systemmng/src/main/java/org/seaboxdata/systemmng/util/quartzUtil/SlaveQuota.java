package org.seaboxdata.systemmng.util.quartzUtil;

import org.apache.ibatis.session.SqlSession;
import org.seaboxdata.systemmng.entity.CarteInfoEntity;
...
import org.seaboxdata.systemmng.util.TaskUtil.CarteStatusVo;
...
public class SlaveQuota {
    ...
    public static void quotaSlaveInfoRepeat() throws Exception {
        ...
        // 采集所有节点的信息
        List<SlaveEntity> slaves = session.selectList("org.seaboxdata.systemmng.dao.SlaveDao.getAllSlave", "");
        ...
        for (CarteInfoEntity carteInfoEntity : carteInfoList) {
            result += session.insert("org.seaboxdata.systemmng.dao.CarteInfoDao.insertCarteInfo", carteInfoEntity);
        }
        session.commit();
