...
//		});
		...
		var loginInfo=//"<div style='display:inline-block;height:100%'><img src='../ui/images/i_headerLogo.png' style='margin:14px 40px;'/></div>" +
			...
			"<span onclick='loginOut()' class='header-operation-Cls'>退出登录</span><span class='header-split-Cls'>|" +
			// "</span><span onclick='updateThisPwd()' class='header-operation-Cls' id='updateThisPw'>修改密码</span></div>"+
