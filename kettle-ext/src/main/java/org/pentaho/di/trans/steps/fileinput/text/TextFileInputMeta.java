...
public class TextFileInputMeta extends
  ...
  public void loadXML( Node stepnode, List<DatabaseMeta> databases, IMetaStore metaStore ) throws KettleXMLException {
    try {
      ...
      for ( int i = 0; i < nrfiles; i++ ) {
        ...
        Node realfilenamenode = XMLHandler.getSubNodeByNr( filenode, "realFileName", i );
        ...
        inputFiles.realFileName[i] = loadSource( filenode, realfilenamenode, i, metaStore );
  ...
  public Object clone() {
    ...
    System.arraycopy( inputFiles.realFileName, 0, retval.inputFiles.realFileName, 0, nrfiles );
  ...
  public void allocateFiles( int nrFiles ) {
    inputFiles.realFileName = new String[nrFiles];
  ...
  public void setDefault() {
    ...
    for ( int i = 0; i < nrfiles; i++ ) {
      ...
      inputFiles.realFileName[i] = "filename" + ( i + 1 );
  ...
  public String getXML() {
    ...
    for ( int i = 0; i < inputFiles.fileName.length; i++ ) {
      ...
      retval.append( "      " ).append( XMLHandler.addTagValue( "realFileName", inputFiles.realFileName[i] ) );
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases )
    ...
    try {
      ...
      for ( int i = 0; i < nrfiles; i++ ) {
        ...
        inputFiles.realFileName[i] = rep.getStepAttributeString( id_step, i, "real_file_name" );
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step )
    ...
    try {
      ...
      for ( int i = 0; i < inputFiles.fileName.length; i++ ) {
        ...
        rep.saveStepAttribute( id_transformation, id_step, i, "real_file_name", inputFiles.realFileName[i] );
