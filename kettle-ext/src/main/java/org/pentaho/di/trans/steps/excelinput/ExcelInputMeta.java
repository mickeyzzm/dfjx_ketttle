...
public class ExcelInputMeta extends BaseStepMeta implements StepMetaInterface {
  ...
  @Injection( name = "REALFILENAME", group = "FILENAME_LINES" )
...
/**
  ...
  public Object clone() {
    ...
    System.arraycopy( realFileName, 0, retval.realFileName, 0, nrfiles );
  ...
  private void readData( Node stepnode ) throws KettleXMLException {
    try {
      ...
      for ( int i = 0; i < nrfiles; i++ ) {
        ...
        Node realfilenamenode = XMLHandler.getSubNodeByNr( filenode, "realName", i );
        Node filemasknode = XMLHandler.getSubNodeByNr( filenode, "filemask", i );
        Node excludefilemasknode = XMLHandler.getSubNodeByNr( filenode, "exclude_filemask", i );
        Node fileRequirednode = XMLHandler.getSubNodeByNr( filenode, "file_required", i );
        Node includeSubFoldersnode = XMLHandler.getSubNodeByNr( filenode, "include_subfolders", i );
        fileName[ i ] = XMLHandler.getNodeValue( filenamenode );
        realFileName[ i ] = XMLHandler.getNodeValue( realfilenamenode );
  ...
  public void allocateFiles( int nrfiles ) {
    ...
    realFileName = new String[ nrfiles ];
  ...
  public String getXML() {
    ...
    for ( int i = 0; i < fileName.length; i++ ) {
      ...
      retval.append( "      " ).append( XMLHandler.addTagValue( "realName", realFileName[ i ] ) );
  ...
  public void readRep( Repository rep, IMetaStore metaStore, ObjectId id_step, List<DatabaseMeta> databases )
    ...
    try {
      ...
      for ( int i = 0; i < nrfiles; i++ ) {
        ...
        realFileName[ i ] = rep.getStepAttributeString( id_step, i, "real_file_name" );
  ...
  public void saveRep( Repository rep, IMetaStore metaStore, ObjectId id_transformation, ObjectId id_step )
    ...
    try {
      ...
      for ( int i = 0; i < fileName.length; i++ ) {
        ...
        rep.saveStepAttribute( id_transformation, id_step, i, "real_file_name", getValueOrEmptyIfNull( realFileName[ i ] ) );
