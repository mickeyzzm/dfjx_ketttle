...
import org.seaboxdata.ext.Task.MybatisDaoSuppo;
import org.seaboxdata.ext.utils.ExceptionUtils;
...
//	private Map<StepMeta, String> stepLogMap = new HashMap<StepMeta, String>();
	...
	public JSONArray getJobMeasure1() throws Exception {
    	JSONArray jsonArray = new JSONArray();
    	if(executionConfiguration.isExecutingLocally()) {
    		JobTracker jobTracker = job.getJobTracker();
            // Re-populate this...
